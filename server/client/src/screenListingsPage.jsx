const screenListingsPage = () => {
    return (
        <>
            ...
            <div class="container card w-50 mx-auto text-center">
                <div class="card-body">
                    <img src="https://static.homemcr.org/app/uploads/2015/04/Cinema-1-Seating-Plan.jpg" alt="standard screen seating plan"></img>
                    <h5 class="card-title">Standard Screen</h5>
                    <p class="card-text">For those who are paranoid of spending £3.00 on a bag of sweets. Sometimes, simple is best!</p>
                </div>
            </div>
