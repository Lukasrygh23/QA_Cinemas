                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">Gabriel Jose
                                        <p>Development Team (Front - end)</p>
                                    </li>
                                    <li class="list-group-item">Lukas Rygh
                                        <p>Product Owner</p>
                                    </li>
                                    <li class="list-group-item">Samuel Sheldon
                                        <p>Development Team (Back - end)</p>
                                    </li>
                                    <li class="list-group-item">Solomon Boundy
                                        <p>Development Team (Front - end)</p>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <ul>
                                    ...
                                    <a href="https://twitter.com/QA_Ltd?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank" className="text-primary" id="link">Twitter</a>
                                    <br></br>
                                    <a href="https://www.qa.com/" target="_blank" className="text-primary"><img src="https://media-exp1.licdn.com/dms/image/C4E0BAQH4QubXWTOP1Q/company-logo_200_200/0/1609755087564?e=2159024400&v=beta&t=2nvYcVJplopIypFkazkYjD9ZAEEIQjlKllQATlOz8bs" alt="qa logo" width="20" height="20"></img>Website</a>
                                    <br></br>
                                    ...
                                    <a href="https://www.instagram.com/qalimited/?hl=en" target="_blank" className="text-primary">Instagram</a>
                                    <br></br>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                                    </svg>
                                    <a href="https://www.facebook.com/QALtd/" target="_blank" className="text-primary">Facebook</a>
                                </ul>
                            </div>
                        </div>
                    </div>
