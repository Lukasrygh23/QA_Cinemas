    ...
    return (
            <Carousel autoPlay={true} showThumbs={false} interval={5000} infiniteLoop={true} showStatus={false} showIndicators={false} >
                <div className="divContainer">
                    <img style={{"pointer-events": "all"}} onClick={movie1Handler} className="carouselImages" src="https://cdn.mos.cms.futurecdn.net/dNmCDjJT5G76aDKiYphTkF.jpg" alt="No Time To Die" />
                    ...
                    <button className="button-62 mb-2" onClick={movie1BookingHandler}>Book now</button>
                </div>
                <div>
